...
Serie 1 = Game of Thrones, genero: fantasia, tempoEpisodio: 60
Serie 2 = Dark, genero: drama, tempoEpisodio: 60
Serie 2 = Love, Deads and Robots, genero: animação, tempoEpisodio: 20
 */
...
public class ExemploOrdenaçãoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries = new HashSet<Serie>() {{
            ...
            add(new Serie("Love, Deads and Robots", "Animação", 20));
        }};
